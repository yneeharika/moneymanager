...
import 'package:moneymanager/pages/dialog.dart';
import 'package:moneymanager/pages/helper.dart';
import 'package:moneymanager/pages/settings.dart';
import 'package:moneymanager/pages/snackbar.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  getTotalBalance(List<TransactionModel> entireData) {
    ...
    for (TransactionModel data in entireData) {
      print('Transaction Type :${data.type}, amount :${data.amount}');
